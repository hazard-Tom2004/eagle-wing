...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        'primary': '#0F172A',       // Deep charcoal (BeeSeek-inspired)
        'primary-light': '#1E293B', // Lighter charcoal
        'secondary': '#D97706',     // Amber/Gold - Energy & CTAs
        'secondary-light': '#F59E0B', // Light amber
